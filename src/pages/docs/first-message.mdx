...
<div class='warning'>
  ...
  need to go to their{' '}
  <a href='https://github.com/EssentialsX/Essentials/blob/2.x/Essentials/src/messages.properties'>
    GitHub
  </a>
  , grab the file and place it into your <code>plugins/Essentials</code> folder.
</div>
